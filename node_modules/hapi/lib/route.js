...
const Auth = require('hapi/lib/auth');
const Config = require('hapi/lib/config');
const Cors = require('hapi/lib/cors');
const Ext = require('hapi/lib/ext');
const Handler = require('hapi/lib/handler');
const Headers = require('hapi/lib/headers');
const Security = require('hapi/lib/security');
const Streams = require('hapi/lib/streams');
const Validation = require('hapi/lib/validation');
