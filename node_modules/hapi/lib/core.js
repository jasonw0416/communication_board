...
const Compression = require('hapi/lib/compression');
const Config = require('hapi/lib/config');
const Cors = require('hapi/lib/cors');
const Ext = require('hapi/lib/ext');
const Methods = require('hapi/lib/methods');
const Request = require('hapi/lib/request');
const Route = require('hapi/lib/route');
const Toolkit = require('hapi/lib/toolkit');
